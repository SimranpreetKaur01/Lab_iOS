...
let calisthenicsChallenges = ["Do 50 push-ups a day", "Hold a 2-minute plank"]
let weightliftingChallenges = ["Deadlift twice a week", "Bench press your bodyweight"]
...
if challenges.count > 1 && challenges[1].count > 0 {
    print("First challenge in the running list: \(challenges[1][0])")
}
