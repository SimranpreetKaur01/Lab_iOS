...
registrationList += ["Alex", "Chris", "Taylor", "Jordan"]

print("\nAfter adding four more participants:")
print(registrationList)
...
print("After changing the sixth element to Elton:")
print(registrationList)
