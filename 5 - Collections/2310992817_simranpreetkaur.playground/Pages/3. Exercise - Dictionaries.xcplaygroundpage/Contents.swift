...
print("Initial monthDays dictionary:")
print(monthDays)
...
print("After updating February for leap year:")
print(monthDays)

//:  Use if-let syntax to retrieve the number of days under "January." If the value is there, print "January has 31 days", where 31 is the value retrieved from the dictionary.

if let januaryDays = monthDays["January"] {
...
let categorizedItems: [String: [String]] = [
    "Shapes": shapesArray,
    "Colors": colorsArray
]

print("Categorized Items Dictionary: \(categorizedItems)")
...
if let colors = categorizedItems["Colors"] {
    if let lastColor = colors.last {
        print("Last color in Colors array: \(lastColor)")
    }
}
