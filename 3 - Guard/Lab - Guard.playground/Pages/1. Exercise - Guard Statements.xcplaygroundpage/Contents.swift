...
if let area1 = calculateArea(x: 5.0, y: 10.0) {
    ...
    print("Invalid dimensions for Area 1.")
}

if let area2 = calculateArea(x: -3.0, y: 8.0) {
    print("Area 2: \(area2)")
} else {
    print("Invalid dimensions for Area 2.")
}
...
if let result1 = add(10, 20) {
    print("Sum 1: \(result1)")
} else {
    print("Sum 1: One or both values were nil.")
}

if let result2 = add(nil, 5) {
    print("Sum 2: \(result2)")
} else {
    print("Sum 2: One or both values were nil.")
}
...
if let user = createUser() {
    ...
    print("Failed to create user: Missing input.")
}
