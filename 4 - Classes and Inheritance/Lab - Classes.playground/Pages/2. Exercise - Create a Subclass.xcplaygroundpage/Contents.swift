...
class Fighter: Spaceship {
    ...
    func fire() {
        if remainingFirePower > 0 {
            ...
            print("Fired! Remaining fire power: \(remainingFirePower)")
        } else {
...
print("Error: 'falcon' is an instance of Spaceship, which does not have a 'weapon' property. 'weapon' exists only in the Fighter subclass.")
