...
func checkAge(_ ageInput: String) -> Int?{
...
print("Returned age: \(String(describing: result1))")
...
if let price = getItemPrice(for: "Chips") {
    print("The price of Chips is $\(price)")
} else {
    print("Chips are out of stock or unavailable.")
}

if let price = getItemPrice(for: "Donuts") {
    print("The price of Donuts is $\(price)")
} else {
    print("Donuts are out of stock or unavailable.")
}
