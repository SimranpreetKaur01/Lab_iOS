...
if let breakfast = getMeal(for: "Breakfast") {
    print("Breakfast: \(breakfast.food), \(breakfast.calories) calories")
} else {
    print("Breakfast not logged.")
}

if let lunch = getMeal(for: "Lunch") {
    print("Lunch: \(lunch.food), \(lunch.calories) calories")
} else {
    print("Lunch not logged.")
}
